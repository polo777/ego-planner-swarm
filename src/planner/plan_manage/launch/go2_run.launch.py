...
def generate_launch_description():
    ...
    # rviz_config_path = LaunchConfiguration('rviz_cfg', default="/roo/ros2_ws/src/ego-planner-swarm/src/planner/plan_manage/launch/go2_test.rviz")
    # rviz_config_path_cmd = DeclareLaunchArgument(
    #     'rviz_cfg', default_value="/roo/ros2_ws/src/ego-planner-swarm/src/planner/plan_manage/launch/go2_test.rviz",
    ...
    advanced_param_include = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(
            get_package_share_directory('ego_planner'), 'launch', 'go2_advanced_param.launch.py')),
        launch_arguments={
            'drone_id': drone_id,
            ...
            'camera_pose_topic': 'pcl_render_node/camera_pose',   #MB ???
    ...
    # super_odometry = IncludeLaunchDescription(
    #     PythonLaunchDescriptionSource([os.path.join(
    ...
    # ld.add_action(rviz_config_path_cmd)
