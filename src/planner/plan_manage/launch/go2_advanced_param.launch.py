...
def generate_launch_description():
    ...
    ego_planner_node = Node(
        ...
        output='screen',
        remappings=[
            ('odom_world', [odometry_topic]),  #MB changed to remove "drone_id_" header ('drone_', drone_id, '_', )
            ...
            ('grid_map/odom', [odometry_topic]),   #MB changed to remove "drone_id_" header ('drone_', drone_id, '_', )
            ('grid_map/cloud', [cloud_topic]),     #MB changed to remove "drone_id_" header ('drone_', drone_id, '_', )
